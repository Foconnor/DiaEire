...
function page() {
  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-[var(--grey-200)]">
      <div className="bg-[var(--background)] h-fit w-[440px] rounded-2xl border border-[var(--line)] flex flex-col justify-center items-center p-10">
        <Link href="/">
          {logo ? (
            <img
              className="w-[200px]"
        ...
        <p className="text-center">
          Sign Up to labour to continue to Labour Hub.
        </p>
        <form action="">
          <input
            type="email"
