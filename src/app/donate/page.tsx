          ...
          <div>
            ...
            >
              ...
              <input
                type="hidden"
                name="business"
                value="anthonycasey654@gmail.com"
              />
              <input type="hidden" name="currency_code" value="EUR" />
              <input type="hidden" name="custom" value="USER123" />
              <input
                className="hidden"
                type="number"
                name="amount"
                ...
                value={donationValue}
              />
              <button className="rounded-sm bg-[#ffc439] h-[45px] w-full flex items-center justify-center hover:brightness-95 transition-all duration-200 ease-in-out">
                <img
                  className=""
