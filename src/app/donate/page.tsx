    ...
    <div className="wrapper grid grid-cols-1 md:grid-cols-2 gap-20">
      <div className="mt-5">
        <div className="flex items-center justify-between">
          ...
          <Link
            href="/share"
            className="text-[14px] h-10 w-[96px] flex justify-center items-center border border-[var(--line)] rounded-[8px] px-3"
          >
            {/* SVG icon */}
            <svg
        ...
        <div className="flex gap-3 mt-4">
          ...
          <Link href="/privacy#cookies" className="underline font-ibm">
            Cookie Policy
          </Link>
        </div>
      </div>
      <div className="flex flex-col w-full min-h-screen px-4 md:px-30 justify-center border-l border-[var(--line)] font-ibm">
        {step === 1 && (
          <>
        ...
        <div className="mt-4 flex gap-2 flex-wrap">
          <Link href="#" className="underline text-sm opacity-80 flex-shrink-0">
