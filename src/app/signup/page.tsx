...
function page() {
  ...
  return (
    <div className="flex flex-col items-center justify-start w-[100vw_-_16px] h-screen pt-5 mx-4">
      <Link href="/">
        {logo ? (
          <img
      ...
      <div className="mt-5 flex gap-10 md:flex-row flex-col items-center md:items-start">
        <div className="w-full md:w-fit">
          ...
          <p>
            Let's stay in touch. Sign up for regular updates, including the <br />
        ...
        <div className="p-8 md:w-[340px] w-full rounded-md shadow-[4px_16px_48px_0px_#19193629]">
          <form action="">
            ...
            <p className="mt-2 text-[9px] text-center">
              You can manage your preferences or unsubscribe at any time. If you
              would like to know more about how we use your information click
              here. When 'no' is selected, your data will be processed with the
              express purpose of delivering the content you have signed up for,
              for example, but not limited to: a manifesto, or an event
              invitation - you will receive no further marketing communications
