...
function VisionEdit() {
  ...
  useEffect(() => {
    const getSectionData = async () => {
      ...
      try {
        ...
        toast.error("Error fetching vision page data");
        console.error("Error fetching vision page data:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.error("Failed to update vision page.");
  ...
  return (
    <div className="wrapper !mt-10 p-5 shadow-md rounded-md">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl">Vision Page</h2>
